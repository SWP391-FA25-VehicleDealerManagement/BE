...
public class UserMapper {
	...
	public UserInfo toUserInfo(User u) {
		...
		userInfo.setUserId(u.getUserId() != null ? u.getUserId().longValue() : null);
		...
		if (u.getDealer() != null) {
			...
			dealerInfo.setDealerId(u.getDealer().getDealerId() != null ? u.getDealer().getDealerId().longValue() : null);
	...
	public AdminUserInfoResponse toAdminInfo(User u) {
		...
		adminInfo.setFullName(u.getFullName());
